...
#include "MyCppProject2/Trigger.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	MYCPPPROJECT2_API UClass* Z_Construct_UClass_ATrigger_NoRegister();
	MYCPPPROJECT2_API UClass* Z_Construct_UClass_ATrigger();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATrigger_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATrigger_OnOverlapBegin, "OnOverlapBegin" }, // 1581498223
		{ &Z_Construct_UFunction_ATrigger_OnOverlapEnd, "OnOverlapEnd" }, // 3544864151
	};
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATrigger_Statics::NewProp_CollisionBox_MetaData[] = {
		{ "Category", "Trigger" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Trigger.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATrigger_Statics::NewProp_CollisionBox = { "CollisionBox", nullptr, (EPropertyFlags)0x00100000000a000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ATrigger, CollisionBox), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ATrigger_Statics::NewProp_CollisionBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATrigger_Statics::NewProp_CollisionBox_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATrigger_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATrigger_Statics::NewProp_CollisionBox,
	};
	...
	IMPLEMENT_CLASS(ATrigger, 1911170086);
	template<> MYCPPPROJECT2_API UClass* StaticClass<ATrigger>()
	{
		return ATrigger::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ATrigger(Z_Construct_UClass_ATrigger, &ATrigger::StaticClass, TEXT("/Script/MyCppProject2"), TEXT("ATrigger"), false, nullptr, nullptr, nullptr);
